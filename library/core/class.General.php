...
class General
{
    ...
    static public function getMessage()
    {
        if (isset($_SESSION['error']) || isset($_SESSION['success'])) {
            ...
            if (isset($_SESSION['error']) && is_array($_SESSION['error'])) {
                ...
                $errorText .= "</ul>";
                $divValue .= "<table style='border:2px solid pink; border-radius:5px;margin-top:10px; padding:5px;font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#FF3300;' width='100%'><tr><td valign='top' width='28'><img src=\"" . __TEMPLATE_URL . "images/error_image.png\" width=\"20\" height=\"20\" /></td><td>" .
                    "<strong>Following Error(s) has occurred:</strong>" . $errorText
                    . "</td></tr></table>";
                echo $divValue;
            } elseif (isset($_SESSION['success'])) {
                $divValue = "<table style='border:1px solid green; border-radius:5px; margin-top:10px; padding:5px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#009900;' width='100%'><tr><td width='28' valign='top'><img src=\"" . __TEMPLATE_URL . "images/success_image.png\" width=\"20\" height=\"20\" /></td><td>" . $_SESSION['success'] . "</td></tr></table>";
                echo $divValue;
            }
    ...
    static function getFullNavigation($totalRecords, $totalPages, $presentPage, $presentLink)
    {
        ...
        $finalHTML = '<table width="98%" class="pagination" cellpadding="0" cellspacing="0">
                        <tr>
