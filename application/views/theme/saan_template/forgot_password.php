        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td align="left" valign="top">
                    <div class="heading">Request a New Password</div>
                    <?=General::getMessage()?>
                    <form name="forgot_password" id="forgot_password" action="" method="post" class="jqtransform">
                        <table width="90%" border="0" cellspacing="3" cellpadding="3" align="center"
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="user_email" id="user_email"
                                           value="<?=$PostRetain['user_email']?>"></td>
                            </tr>
                            <tr>
                                <td>&nbsp;</td>
                                <td><input type="submit" name="btn_submit" id="btn_submit" value="Request New Password">
                                    <br><span class="required">* Marked Fields are Mandatory</span>
                                </td>
                            </tr>
                        </table>
                    </form>
