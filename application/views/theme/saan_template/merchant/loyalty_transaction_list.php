                ...
                <td>
                    ...
                    ?>
                        ...
                        foreach($LoyaltyTranDetailsArray['result_set'] as $transactionArray){
                            ...
                            <tr>
                                <td><?=$i?></td>
                                <td><?=$transactionArray['user_full_name']?><br>(<?=$transactionArray['cardnumber_value']?>)</td>
                               	...
                               	<td colspan="5" >
                                    	<table width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF;">
                                        	<tr>
                                                ...
                                                <td width="40%"><?=$transactionArray['user_full_name']?></td>
                    ...
                    <?php
                    $paginationContent = General::getFullNavigation($LoyaltyTranDetailsArray['total_rows'], $LoyaltyTranDetailsArray['total_pages'], $PresentPage, "merTransaction/store_offers");
