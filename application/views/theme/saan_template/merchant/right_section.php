                        	...
                        	<table width="96%" cellpadding="0" cellspacing="0">
                            	<tr>
                                	<td align="center" valign="top">
                            			<img src="<?=appController::getUserImageByUserType($_SESSION['mer_user_id'], '2')?>" style="border-radius:5px; border: 2px #ffffff solid; max-width:100px; max-height:100px;">        
                                    </td>
                                </tr>
                                <tr>
                                	<td align="center" valign="top">
                            			<strong><?=($userNameArray == '')?"Merchant User":$userNameArray?></strong>
                                    </td>
                                </tr>
                            </table>
